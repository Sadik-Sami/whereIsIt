...
import { Sun, Moon, Menu, X, LogOut, Search, PlusCircle, CheckCircle, Package, Info, InfoIcon } from 'lucide-react';
					...
					<div className='hidden md:flex md:items-center md:space-x-8'>
						{navLinks.map((link) => (
							<Link
								key={link.to}
								to={link.to}
								className='text-light-foreground dark:text-dark-foreground hover:text-primary dark:hover:text-primary-light transition-colors flex items-center gap-2'>
